...
def textbox(driver):
    ...
    for i in range(1,10):
        ...
        # input_content: randomly choose one
        text = np.random.choice(['1863552437', '123', '186355243a', '!@#4', '0021!','186355243!','1863552417'])
...
def result_verification(driver,text):
    ...
    #case2: invalid text
        ...
        if len(text) == 10 :
            ...
            print('sorry! you get correct length of serial number, but i only have 1863552437 device info to do validation.')
